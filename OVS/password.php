...
<body>
	<div class="login-box">
		...
		<form action="#" method="post">
			<div class="textbox">
			<input type="Pass" placeholder="*Enter New Password." name="reg" value="">
		</div>
		
		<div class="textbox">
			<input type="Password" placeholder="*Confirm Password" name="roll" value="">
		</div>
		...
		<?php
			...
			$b=$_POST['roll'];
				if($a===$b)
				{
			$sql='insert into pass(password,cpassword) values('.$a.','.$b.')';
